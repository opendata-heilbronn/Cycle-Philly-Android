...
import de.grundid.plusrad.NotificationUtils;
...
public class RecordingService extends Service implements LocationListener {
	...
	public void remindUser() {
		...
		String contentTitle = "Cycle Philly - Recording";
		String contentText = "Tap to see your ongoing trip";
		Intent notificationIntent = new Intent(this, RecordingActivity.class);
		PendingIntent contentIntent = PendingIntent.getActivity(this, 0, notificationIntent, 0);
		final int RECORDING_ID = 1;
		NotificationUtils.showNotification(this, RECORDING_ID, R.drawable.ic_directions_bike_black_24dp, contentTitle,
