/**
 * PlusRad, Copyright 2014 Code for Philly
 *
...
public class RecordingActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mInProgress = false;
		googleApiClient = new GoogleApiClient.Builder(this, this, this).addApi(ActivityRecognition.API).build();
		//////////
	...
	void touchFirebase() {
		...
		//        String fbId;
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd", Locale.US);
		DatabaseReference tripsRef = FirebaseDatabase.getInstance()
				.getReference("cyclephilly-firebaseio-com/trips-started/" +
						sdf.format(new Date(System.currentTimeMillis())));
		DatabaseReference newPushRef = tripsRef.push();
	...
	public void startUpdates() {
		...
		if (!mInProgress) {
			...
			googleApiClient.connect(); // Request a connection to Location Services
		} else {
			/*
